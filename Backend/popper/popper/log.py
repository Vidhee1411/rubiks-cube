...
class Experiment:
    def __init__(self, debug=False, stats=False, max_solutions=1, functional_test=False, clingo_args=""):
        # self.args = parse_args()
        self.timeout: float = 600
        self.max_literals: int = 100
        ...
        self.clingo_args = [] if not clingo_args else clingo_args.split(' ')
